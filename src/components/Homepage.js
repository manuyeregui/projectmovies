...
function Homepage() {
  ...
  return (
    <main>
      ...
      >
          <MoviesWrapper displayOnDesktop={false} title="POPULAR RIGHT NOW." api={'https://api.themoviedb.org/3/movie/popular?api_key=' + process.env.REACT_APP_TMDB_KEY + '&language=en-US&page=1'} showRating={true}/>
          <MoviesWrapper displayOnDesktop={false} title="TODAY TRENDING." api={'https://api.themoviedb.org/3/trending/movie/day?api_key=' + process.env.REACT_APP_TMDB_KEY} showRating={false}/>
          <MoviesWrapper displayOnDesktop={false} title="TOP RATED." api={'https://api.themoviedb.org/3/movie/top_rated?api_key=' + process.env.REACT_APP_TMDB_KEY + '&language=en-US&page=1'} showRating={true}/>
          <MoviesWrapper displayOnDesktop={false} title="UPCOMING." api={'https://api.themoviedb.org/3/movie/upcoming?api_key=' + process.env.REACT_APP_TMDB_KEY + '&language=en-US&page=1'} showRating={false}/>
      </motion.div>
    </main>
  );
}
